/*
    ...
    OpenGL loader generated by glad 0.1.36 on Tue Oct  7 16:13:24 2025.
...
PFNGLACTIVEprogramPROC glad_glActiveprogram = NULL;
...
PFNGLCREATEprogramVPROC glad_glCreateprogramv = NULL;
...
static void load_GL_VERSION_4_1(GLADloadproc load) {
	...
	glad_glActiveprogram = (PFNGLACTIVEprogramPROC)load("glActiveprogram");
	glad_glCreateprogramv = (PFNGLCREATEprogramVPROC)load("glCreateprogramv");
